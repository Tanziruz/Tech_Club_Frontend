    // FileName: /MeetOurTeam.js
    import React from 'react';


    // Reusable component for a single board member card
    const BoardMemberCard = ({ role, name, className = '' }) => (
      <div className={`text-center w-48 flex-shrink-0 mx-2 my-2 rounded-lg shadow-lg overflow-hidden ${className}`}>
    ...
    const GroupLabel = ({ label, className = '' }) => (
      <div className={`px-4 py-1 bg-yellow-400 rounded-lg text-sm font-bold text-gray-900 mb-4 ${className}`}>
        {label.toUpperCase()}
      </div>
    );
      ...
      return (
        <div className="min-h-screen bg-gray-950 text-white flex flex-col items-center pt-20 p-8">
          ...
          <div className="relative flex flex-col items-center w-full max-w-6xl py-8">
            ...
            <div className="w-px h-12 bg-gray-600 my-2"></div>
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="relative flex justify-center w-full mt-4">
                ...
                <div className="absolute top-0 h-px bg-gray-600" style={{ width: 'calc(100% - 120px)', left: '60px', right: '60px' }}></div>

                {/* Vertical lines down from the horizontal connector */}
                <div className="absolute top-0 left-1/4 transform -translate-x-1/2 w-px h-8 bg-gray-600"></div>
                <div className="absolute top-0 right-1/4 transform translate-x-1/2 w-px h-8 bg-gray-600"></div>
                <div className="absolute top-0 w-px h-8 bg-gray-600" style={{ left: '50%', transform: 'translateX(-50%)' }}></div>
                ...
                <div className="flex justify-around w-full mt-8 flex-wrap">
                  ...
                  <div className="flex flex-col items-center w-full sm:w-1/3 min-w-[300px] mb-8 sm:mb-0">
                    ...
                    <div className="relative flex justify-center w-full">
                      ...
                      <div className="absolute top-0 h-px bg-gray-600" style={{ width: 'calc(100% - 50px)', left: '25px', right: '25px' }}></div>
                      ...
                      <div className="flex flex-wrap justify-center gap-2 mt-8 relative">
                        ...
                        <div className="absolute w-px h-8 bg-gray-600" style={{ top: '-32px', left: '10%', transform: 'translateX(-50%)' }}></div>
                        <div className="absolute w-px h-8 bg-gray-600" style={{ top: '-32px', left: '35%', transform: 'translateX(-50%)' }}></div>
                        <div className="absolute w-px h-8 bg-gray-600" style={{ top: '-32px', left: '60%', transform: 'translateX(-50%)' }}></div>
                        <div className="absolute w-px h-8 bg-gray-600" style={{ top: '-32px', left: '90%', transform: 'translateX(-50%)' }}></div>
